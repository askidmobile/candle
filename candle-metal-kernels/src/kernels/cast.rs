...
pub fn call_cast_contiguous(
    ...
    set_params!(encoder, (length, &input, Output::with_offset(output, output_offset)));
...
pub fn call_cast_strided(
    ...
    set_params!(
        encoder,
        (length, shape.len(), shape, input_strides, &input, Output::with_offset(output, output_offset))
    );
