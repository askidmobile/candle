...
nsys profile -o D:\Projects\yttri-build\trace27iq --force-overwrite=true -t cuda --cuda-graph-trace=node --delay 108 --duration 45 target\release\bench_candle_direct.exe D:\Models\unsloth\Qwen3.6-27B-GGUF\Qwen3.6-27B-UD-IQ2_XXS.gguf
