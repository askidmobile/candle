...
// ВНИМАНИЕ: ЗАГЛУШКА. IQ1_S/IQ1_M не инстанцированы в candle_mmq_dense.cu и
// не диспатчатся из mul_mat_q_mma. Прежде чем включать IQ1 в MMQ — заполнить
// таблицу из ggml-common.h (заглушённые grid-таблицы уже давали ровно нулевой
// выход MMQ для всех IQ-типов, см. mmq_mma_iq_matches_reference).
